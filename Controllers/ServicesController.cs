...
namespace Learn_CRUD_CoreWebApp_MVC.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(ProviderDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Services != null ?
                        ...
                        Problem("Entity set 'ProviderDbContext.Services'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ServiceId,Caption")] Services services)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceId,Caption")] Services services)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProviderDbContext.Services'  is null.");
            }
            var services = await _context.Services.FindAsync(id);
            if (services != null)
            {
